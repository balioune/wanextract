    ...
    for hour in range(1, 5):
        try:
            ...
            for interface in Interface.objects.all():
                ...
                response = burst_per_interface_hourly(global_headers, interface.truview_if_id, interface.deviceIp,
                ...
                apps_throughput = throughput_per_interface_hourly(global_headers, interface.truview_if_id,
                                                                  interface.deviceIp,
                                                                  interface.deviceName, str(START) + '000',
                                                                  str(END) + '000')
                ...
                if "records" in response.keys():
                    for app in response['records']:
                        ...
                        if Burst4 == 1:
                            ...
                            o1 = OutInterfaceBurst(timestamp=timestamp, date=date_en, time=time_en, interface=interface,
                                                   OutBurst1=OutBurst1,
                                                   OutBurst2=OutBurst2, OutBurst3=OutBurst3, OutBurst4=OutBurst4,
                                                   Burst3=Burst3,
                                                   Burst4=Burst4)
                ...
                if "records" in response.keys():
                    for app in response['records']:
                        ...
                        if Burst4 == 1:
                            ...
                            i1 = InInterfaceBurst(timestamp=timestamp, date=date_en, time=time_en, interface=interface,
                                                  InBurst1=InBurst1,
                                                  InBurst2=InBurst2, InBurst3=InBurst3, InBurst4=InBurst4,
                                                  Burst3=Burst3,
                                                  Burst4=Burst4)
