...
$(document).ready(function chart_values(){
    $.ajax({
        // We have some issue with CRCF django when using the POST method
        // Error: Forbidden (CSRF token missing or incorrect.
        // that's why we use a GET to fetch data
        type: 'GET',
        url: '/comptabilite/getdata',
        dataType: 'json',
        data: '',
              ...
              yAxes: [{
                ticks: {
                  ...
                  callback: function(value, index, values) {
                    return 'XOF ' + number_format(value);
                  }
                },
                gridLines: {
            ...
            tooltips: {
              ...
              callbacks: {
                label: function(tooltipItem, chart) {
                  ...
                  return datasetLabel + ': XOF ' + number_format(tooltipItem.yLabel);
                }
              }
            }
          }
